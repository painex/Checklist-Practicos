...
export interface Todo_dato{
    ...
    Observacion: string;
    //Pre operacional
    chequeo_pre_operacion: string;
    interior_cabina_pickup: string;
    revisa_vehiculo_antes: string;
    revisa_equipo_epp: string;
    //Conducción
    uso_espejos_punto_ciego:string;
    conduce_manos_volante:string;
    uso_frenos: string;
    hace_buen_uso_marcha:string;
    uso_embrague:string;
    estaciona_acorde_terreno:string;
    //Seguridad
    respeta_senializacion: string;
    mira_anticipacion:string;
    controla_riesgo_ruta: string;
    demuestra_conduccion_segura:string;
    //CONOCIMIENTO OPERACIONAL GENERAL 
    traccion_4h4l: string;
    opera_sistema_radial: string;
    domina_porc_cadena:string;
    entiende_operacion_vehiculo:string;
    //Actitud y Experiencia
    refleja_experiencia:string;
    actitud_evaluacion:string;
    
    nota:number;
}


export class Todo_dato{
    id_persona: number;
    rut: string;
    nombre: string;
    cargo: string;
